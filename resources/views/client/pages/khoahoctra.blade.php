                            ...
                            <div class="video-gallery">
                                <div class="video-item">
                                    <a href="" target="_blank">
                                        <img src="{{asset('/images/vd1.jpg')}}"
                                            alt="How to Brew Green Tea">
                                        <h4>Cách pha trà san tuyết</h4>
                                    </a>
                                </div>
                                <div class="video-item">
                                    <a href="https://www.youtube.com/watch?v=your_video_2" target="_blank">
                                        <img src="{{asset('/images/vd2.jpg')}}" alt="Making Herbal Tea">
                                        <h4>Cách vệ sinh dụng cụ trà</h4>
                                    </a>
                                </div>
                                <div class="video-item">
                                    <a href="https://www.youtube.com/watch?v=your_video_3" target="_blank">
                                        <img src="{{asset('/images/vd3.jpg')}}" alt="Perfecting Black Tea">
                                        <h4>Các kiến thức cơ bản về trà
                                        </h4>
                                    </a>
                                </div>
                            </div>
